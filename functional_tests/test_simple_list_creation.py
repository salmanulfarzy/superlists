...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        #  She goes to check check out its homepage
        ...
        ListPage(self).wait_for_row_in_list_table('Use peacock feathers to make a fly', 2)
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We use a new browse session to make sure that no information
